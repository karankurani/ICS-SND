...
public class LDABase implements Serializable {
    ...
    // TODO(jrm): Don't use the UnitTests object here!!!
    private static final String[] STOPWORD_LIST = null; //setStopWordList(UnitTests.DATA_PATH + "dblp_stopwords_only.txt");
